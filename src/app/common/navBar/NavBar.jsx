                    ...
                    >
                        {menuOpen ? (
                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                                <path d="M11.0465 9.30662L17.9295 2.4243C18.3568 1.99704 18.3568 1.30432 17.9295 0.877088C17.5023 0.449825 16.8095 0.449825 16.3823 0.877088L9.49998 7.76012L2.61766 0.877088C2.1904 0.449825 1.49768 0.449825 1.07045 0.877088C0.643219 1.30435 0.643184 1.99708 1.07045 2.4243L7.95348 9.30662L1.07045 16.189C0.643184 16.6162 0.643184 17.3089 1.07045 17.7362C1.49771 18.1634 2.19044 18.1634 2.61766 17.7362L9.49998 10.8531L16.3823 17.7362C16.8095 18.1634 17.5023 18.1634 17.9295 17.7362C18.3568 17.3089 18.3568 16.6162 17.9295 16.189L11.0465 9.30662Z" fill="#6B7280" />
                            </svg>
                        ) : (
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                <path d="M4 12.3301H20" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M4 18.3301H20" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M4 6.33008H20" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        )}
                    </div>
                    {/* logo */}
                                ...
                                <div className={styles.avatardetails}>
                                    ...
                                    <div className={styles.arrow}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path d="M7.5 15L12.5 10L7.5 5" stroke="#4B5563" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                            </div>
