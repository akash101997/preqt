...
export default function Sidenav() {
  ...
  <path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" fill="rgba(201, 167, 78, 1)"/>
        ...
        <Link href={'/account/details'} className={styles.Link}> <span>Account Details</span></Link> 
        </li>


        <li className={styles.item}>
          <img className={styles.icon} src='/account_sidenav/transation.svg' alt='' />
        <Link href={'/account/transation'} className={styles.Link}>  <span className={styles.span}> Transactions</span></Link>
        </li>


        <li className={styles.item}>
           <img className={styles.icon} src='/account_sidenav/24-support.svg' alt='' />
            <Link href={'/account/support'} className={styles.Link}><span className={styles.span}>Support</span></Link>
        </li>


        <li className={styles.item}>
          <img className={styles.icon} src='/account_sidenav/notification.svg' alt='' />
            <Link href={'/account/notification'} className={styles.Link}><span className={styles.span}>Notification preference</span></Link>
        ...
        <li className={styles.item}>
          ...
          <Link href={'/account/faq'} className={styles.Link}><span className={styles.span}>Frequently Asked Questions</span></Link>
        </li>


        <li className={styles.item}>
             <img className={styles.icon} src='/account_sidenav/privacy_policy.svg' alt='' />
           <Link href={'/account/privacyPolicy'} className={styles.Link}><span className={styles.span}>Privacy Policy</span></Link>
        </li>


        <li className={styles.item}>
             <img className={styles.icon} src='/account_sidenav/my-documents.svg' alt='' />
          <Link href={'/account/my-document'} className={styles.Link}><span className={styles.span}>My documents</span></Link>
        </li>
