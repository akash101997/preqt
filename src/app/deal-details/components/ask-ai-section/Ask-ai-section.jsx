    ...
    <section className="ask-ai-section">
      ...
      <div className="ask-ai-section1">
        <section>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g filter="url(#filter0_d_2198_14944)">
              <circle cx="22.5" cy="23" r="6.5" fill="#16A34A" />
            </g>
            <defs>
              <filter
                id="filter0_d_2198_14944"
                x="0"
                y="0.5"
                width="45"
                height="45"
              ...
              >
                ...
                <feColorMatrix
                  type="matrix"
                  values="0 0 0 0 0.0862745 0 0 0 0 0.639216 0 0 0 0 0.290196 0 0 0 0.4 0"
                />
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_2198_14944"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_2198_14944"
                  result="shape"
                />
              </filter>
            </defs>
          </svg>
          We have 15+ new deals
        </section>
      ...
      <div className="ask-ai-section2">
        <div className="image-stack">
          <img src="/assets/pictures/stack.png" alt="Person 1" />
