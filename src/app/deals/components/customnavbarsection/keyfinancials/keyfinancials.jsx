...
const Keyfinancials = ({ isPrivateDeal = false }) => {
  ...
  return (
    ...
    <div
      className={`key-financials-container ${
        isPrivateDeal ? "private-deal" : ""
      }`}
    >
      {/* Financial Trends */}
                    ...
                    <div className="accordion-body">
                      ...
                      <div className="metric-block">
                        ...
                        <p>
                          ...
                          <span
                            className={
                              item.growth < 0 ? "negative" : "positive"
                            }
                          >
                      ...
                      <div className="metric-block">
                        ...
                        <p>
                          ...
                          <span
                            className={
                              item.ebitda < 0 ? "negative" : "positive"
                            }
                          >
                      ...
                      {item.year !== "2023" && item.year !== "2024" && (
                        <div className="metric-block">
                          ...
                          <p>
                            ...
                            <span
                              className={
                                item.peratio < 0 ? "negative" : "positive"
                              }
                            >
                              {item.peratio == 0 ? "-" : item.peratio + "x"}
                            </span>
                          </p>
                        </div>
                      )}
                      ...
                      <div className="metric-block">
                        ...
                        <p>
                          ...
                          <span>ROA</span>{" "}
                          <span
                            className={item.roa < 0 ? "negative" : "positive"}
                          >
                            {item.roa == 0 ? "-" : item.roa + "%"}
                          </span>
                        </p>
                        <p>
                          ...
                          <span>ROE</span>{" "}
                          <span
                            className={item.roe < 0 ? "negative" : "positive"}
                          >
                            {item.roe == 0 ? "-" : item.roe + "%"}
                          </span>
                        </p>
                      ...
                      <div className="metric-block">
                        ...
                        <p>
                          ...
                          <span
                            className={
                              item.debttoequity < 0 ? "negative" : "positive"
                            }
                          >
                            {item.debttoequity == 0
                              ? "-"
                      ...
                      <div className="metric-block">
                        ...
                        <p>
                          ...
                          <span
                            className={
                              item.debtordays < 0 ? "negative" : "positive"
                            }
                          >
                            {item.debtordays == 0 ? "-" : item.debtordays + ""}
                          </span>
                        </p>
                        <p>
                          ...
                          <span
                            className={
                              item.creditordays < 0 ? "negative" : "positive"
                            }
                          >
                            {item.creditordays == 0
                              ? "-"
                      ...
                      {item.year !== "2023" && (
                        <div className="metric-block">
                          ...
                          <p>
                            ...
                            >
                              {item.longtermfundstofixed == 0
                                ? "-"
                                : item.longtermfundstofixed + "x"}
                            </span>
                          </p>
                        </div>
                      )}
                      ...
                      <div className="metric-block">
                        <h4>Liquidity</h4>
                        <p>
                          <span>Currect Ratio</span>{" "}
                          <span
                            className={
                              item.currentratio < 0 ? "negative" : "positive"
                            }
                          >
                            {item.currentratio == 0
                              ? "-"
                      ...
                      <div className="metric-block">
                        ...
                        <p>
                          ...
                          <span
                            className={item.cogs < 0 ? "negative" : "positive"}
                          >
                            {item.cogs == 0 ? "-" : item.cogs + "%"}
                          </span>
                        </p>
                      </div>
                    </div>
