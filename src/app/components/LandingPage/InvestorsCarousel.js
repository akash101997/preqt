...
const InvestorsCarousel = () => {
    ...
    const carouselData = [
        ...
        { id: 2, text: "Through pr.eqt I discovered high-quality pre-IPO opportunities before they went mainstream. The due diligence tools and secure data rooms gave me confidence to move quickly.", name: "Anita Mehra", position: "Angel Investor & Partner at Horizon Capital", img: "/user-2.png" },
        { id: 3, text: "pr.eqt is a game-changer! The curated deal flow and advanced analytics tools gave me an edge. I've expanded my portfolio with confidence and seen impressive returns.", name: "Marcus Vieri", position: "Partner, Greybrook Investments", img: "/user-1.png" },
        ...
        { id: 5, text: "Highly curated deals and frictionless access. pr.eqt made early investing feel intuitive.", name: "Sophia Turner", position: "Private Investor", img: "/user-1.png" },
    ];
